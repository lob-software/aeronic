...
dependencies {
    annotationProcessor(project(":aeronic-processor"))
...
tasks {
    register<ShadowJar>("benchmarkJar") {
        archiveFileName.set("echo-benchmark.jar")
        manifest {
            attributes["Main-Class"] = "io.aeronic.benchmarks.EchoBenchmark"
        }
