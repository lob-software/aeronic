...
public final class TestClusterNode implements AutoCloseable
{
    ...
    public AeronCluster getCusterClient()
    {
        return client;
    }
    ...
    static class Service implements ClusteredService
    {
        ...
        private AeronicWizard aeronicWizard;
        private final ClusterSystemTest.SimpleEventsImpl simpleEvents;

        public Service(final ClusterSystemTest.SimpleEventsImpl simpleEvents)
        {
            this.simpleEvents = simpleEvents;
        }

        public ClusterSystemTest.SimpleEventsImpl getSimpleEvents()
        {
            return simpleEvents;
        }
        ...
        public void onStart(final Cluster cluster, final Image snapshotImage)
        {
            ...
            aeronicWizard = new AeronicWizard(cluster.aeron());
            aeronicWizard.registerSubscriber(SimpleEvents.class, simpleEvents, "aeron:ipc", 10);
            aeronicWizard.awaitUntilPubsAndSubsConnect();
            aeronicWizard.start();
        }
        ...
        public void onSessionMessage(
            ...
            final Header header)
        {
            // TODO: explore delegating to aeronic subs, perhaps based on encodedPrincipal...
            messageCount++;
